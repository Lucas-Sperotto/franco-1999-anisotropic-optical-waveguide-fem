...
- `waveguide_planar_sweep_consolidate`: consolida os pontos do sweep em CSV rastreáveis.
- `waveguide_planar_sweep_plot`: gera os gráficos SVG do sweep consolidado.
- `waveguide_planar_sweep_artifacts`: garante a presença dos arquivos consolidados e dos três modos mais baixos quando disponíveis.
